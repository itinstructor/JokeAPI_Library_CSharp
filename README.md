...
### Overview
- This C# library converts the JokeAPI at https://v2.jokeapi.dev/joke/Any converts the incoming JSON to C# objects with properties for easy interaction in C# projects.
